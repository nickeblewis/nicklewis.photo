...
class CookieTest extends _react.PureComponent {
  ...
  renderWhiteListForm() {
    ...
    var _this$props = this.props,
        ...
        sanityLogo = _this$props.sanityLogo;
    var redirectTo = "".concat(_client.default.clientConfig.url, "/auth/whitelist?redirectTo=").concat(encodeURIComponent(window.location.toString()));
    return _react.default.createElement("div", {
      ...
      action: "".concat(_client.default.clientConfig.url, "/auth/testCookie"),
