...
var reportErrors = (0, _debounce2.default)(() => {
  ...
  console.groupCollapsed("%cHeads up! Got ".concat(errorCount === 1 ? 'error' : "".concat(errorCount, " errors"), " while preparing data for preview. Click for details.") + ' This may be a hard failure in production and cause your Studio to crash.', 'color: #ff7e7c');
