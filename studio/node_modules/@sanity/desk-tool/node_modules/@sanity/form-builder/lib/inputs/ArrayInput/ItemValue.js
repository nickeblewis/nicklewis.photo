...
class RenderItemValue extends _react.default.Component {
  ...
  renderEditItemForm(item) {
    ...
    var content = _react.default.createElement(_FormBuilderInput.FormBuilderInput, {
      type: memberType,
      level: 0,
    ...
    var title = readOnly || memberType.readOnly ? memberType.title : `Edit ${memberType.title}`;
