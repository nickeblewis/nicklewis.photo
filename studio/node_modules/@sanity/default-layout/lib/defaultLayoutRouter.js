...
var basePath = (_configSanity.project && _configSanity.project.basePath || '').replace(/\/+$/, '');
...
var rootRouter = (0, _router.route)(`${basePath}/`, [_router.route.intents('/intent'), _spaces.HAS_SPACES ? spaceRoute : toolRoute]);
